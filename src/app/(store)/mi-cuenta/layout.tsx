  ...
  return (
    <section className="account-shell section">
      ...
      <div className="account-layout">
        <aside className="account-nav"><nav aria-label="Mi cuenta"><Link href="/mi-cuenta">Resumen</Link><Link href="/mi-cuenta/datos">Datos personales</Link><Link href="/mi-cuenta/direcciones">Direcciones</Link><Link href="/mi-cuenta/pedidos">Pedidos</Link></nav><form action={logoutCustomerAction}><button type="submit">Cerrar sesión</button></form></aside>
